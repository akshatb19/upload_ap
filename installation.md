...
- [Blip Installation](#blip-installation)
    ...
    - [Installing Redis](#installing-redis)
        - [Download, Compile and Install Redis](#download-compile-and-install-redis)
            ...
            - [Build and Install Redis](#build-and-install-redis)
        ...
        - [Start and Test Redis](#start-and-test-redis)
            - [Start the Redis Service](#start-the-redis-service)
            - [Test the Redis Instance Functionality](#test-the-redis-instance-functionality)
